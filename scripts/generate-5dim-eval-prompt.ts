 ...
 *
 * T-521: 5谺｡蜈・ｩ穂ｾ｡繝励Ο繝ｳ繝励ヨ繧ｸ繧ｧ繝阪Ξ繝ｼ繧ｿ繝ｼ
 *
 * src/lib/*.ts 縺ｮ蜈ｨ繝｢繧ｸ繝･繝ｼ繝ｫ繧定ｪｭ縺ｿ蜿悶ｊ縲・ * 蜷・Δ繧ｸ繝･繝ｼ繝ｫ縺ｮ陦梧焚繝ｻ繝・せ繝域焚繝ｻ蜈ｬ髢帰PI謨ｰ繧帝寔險医＠縺ｦ縲・ * 5谺｡蜈・ｼ亥━雜頑ｧ繝ｻ髱ｩ譁ｰ諤ｧ繝ｻ蜷育炊諤ｧ繝ｻ荳雋ｫ諤ｧ繝ｻ蜃ｦ逅・ｲｾ蠎ｦ・峨・
 * 隧穂ｾ｡繝励Ο繝ｳ繝励ヨ繧・output/5dim-eval-prompt.txt 縺ｫ蜃ｺ蜉帙☆繧九・ */
...
// 笏笏笏 Analysis 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
// 笏笏笏 Prompt Generation 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
function generatePrompt(summary: ProjectSummary): string {
    ...
    return `# FlowForge SDK 窶・5-Dimensional Evaluation Prompt
Generated: ${now}
...
### 5. Processing Accuracy (蜃ｦ逅・ｲｾ蠎ｦ)
